	...
	public static function show($varPage)
	{
		...
		<div class="container">
			...
			<form action="" method="post">
				...
				<a href="<?= $GLOBALS['router']->url('inscription') ?>">Vous n'avez pas encore de compte ?</a>
				<a class="btn" href="https://accounts.google.com/o/oauth2/v2/auth?scope=profile email&access_type=online&redirect_uri=<?=$GLOBALS['router']->url('googleConnexion')?>&response_type=code&client_id=<?= $varPage['google_id'] ?>">SE CONNECTER AVEC GOOGLE</a>
			</form>
		</div>
		<?php
