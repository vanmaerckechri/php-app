	...
	public static function index($varPage)
	{
		...
		<div class="container">
			...
			<form action="" method="post">
				...
				<a href="<?=Router::url('registration')?>">Vous n'avez pas encore de compte ?</a>
				<a class="btn" href="https://accounts.google.com/o/oauth2/v2/auth?scope=profile email&access_type=online&redirect_uri=<?=Router::url($varPage['GOOGLE_ROUTE'])?>&response_type=code&client_id=<?= $varPage['GOOGLE_ID'] ?>">SE CONNECTER AVEC GOOGLE</a>
			</form>
		</div>
		<?php
